...
All Stage 2 structuring logic lives here as a set of pure functions: each takes a DataFrame in and returns a new one, so any step can be re-run, tested, or imported independently.
